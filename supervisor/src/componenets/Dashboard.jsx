  ...
  return (
    <div class="bg-white p-8 rounded-md w-full">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
                <div class="bg-orange-600 rounded-md border border-gray-100 p-6 shadow-md shadow-black/5">
                    <div class="flex justify-between mb-6">
                        <div>
                            <div class="flex items-center mb-1">
                                <div class="text-white text-2xl font-semibold">Completed Requests</div>
                            </div>
                            <div class="text-sm font-medium text-white">2 Request</div>
                        </div>
                ...
                <div class="bg-teal-500 rounded-md border border-gray-100 p-6 shadow-md shadow-black/5">
                    <div class="flex justify-between mb-6">
                        <div>
                            <div class="flex items-center mb-1">
                                <div class="text-white text-2xl font-semibold">New Assigned</div>
                            </div>
                            <div class="text-sm font-medium text-white">2 Request</div>
                        </div>
